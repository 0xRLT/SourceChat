...
typedef int ImGuiTextFlags;         // -> enum ImGuiTextFlags_       // Flags: for TextUnformatted()
...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0), bool disabled = false);   // button
    ...
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, bool input = false);
    IMGUI_API bool          InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2& size = ImVec2(0, 0), ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = NULL, void* user_data = NULL, bool input = false);
    ...
    IMGUI_API float         CalcMultilineWordWrapTextHeight(const char *buffer, int size, float width);
    IMGUI_API void          ClearInputText( const char *label );
    ...
    extern ImVec2           FrameBackgroundOffset;
    extern ImU32            CursorColor;
    extern bool             DisableCursorBlinking;
    extern bool             TextShadow;
    extern bool             TextDontIgnoreColorAbsence;
    extern float            TextLineSpacing;
} // namespace ImGui
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_WordWrapping        = 1 << 22,
    ImGuiInputTextFlags_NoVerticalScroll    = 1 << 23,
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_TextUnformattedAlign,// ImVec2    UnformattedTextAlign
    ImGuiStyleVar_COUNT,
};
...
namespace ImGui
{
    extern ImVector<ImTextColorStyle> *ColorfulTextStyle;
    extern ImVector<ImTextOpacity> *TextOpacity;
}
...
struct ImGuiIO
{
    ...
    bool        ContextRightClicked;
    bool        ContextTextHovered;
    bool        ContextSetWindowSize;
    bool        ContextIsInput;
    bool        ContextChoice;
    int         ContextSleep;
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddText(const ImFont* font, float font_size, const ImVec2& pos, ImU32 col, const char* text_begin, const char* text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL, const char *text_selection_begin = NULL, const char *text_selection_end = NULL);
...
struct ImFont
{
    ...
    IMGUI_API void              RenderText(ImDrawList* draw_list, float size, const ImVec2& pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false, const char *text_selection_begin = NULL, const char *text_selection_end = NULL) const;
    IMGUI_API void              RenderTextShadow(ImDrawList* draw_list, float size, const ImVec2& pos, ImU32 col, const ImVec4& clip_rect, const char* text_begin, const char* text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false) const;
